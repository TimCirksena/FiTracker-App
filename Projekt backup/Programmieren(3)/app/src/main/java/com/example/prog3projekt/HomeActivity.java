...
public class HomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Date t = DataTimeHilfsKlasse.getTodaysDateAsDate();
        DataTimeHilfsKlasse.getDatesDayAsInt(t);
        ...
        noteViewModel.getAllNotes().observe(this, new Observer<List<Note>>() {
            ...
            public void onChanged(@Nullable List<Note> notes) {
                ...
                for (int i = 0; i<allNotes.size();i++) {
                    s[i] = new DataPoint(allNotes.get(i).getProzent(), i);
                }
    ...
    private void setUpGraphView(GraphView graphView, int maxX, int maxY){
        ...
        graphView.setTitleColor(R.color.mainColor);
